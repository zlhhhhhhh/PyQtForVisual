...
class StatWindow(SubWindow):
    ...
    def Stat_initUI(self):
        ...
        self.content_label = QtWidgets.QLabel("test")
        self.content_label.setFont(QFont("SimHei",14,QFont.Bold))
        self.content_label.setObjectName("content")
        self.content_label.setScaledContents(True)
        self.content_label.setStyleSheet("QLabel#content{letter-spacing::5px;line-height:1px}")
